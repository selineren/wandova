...
final class CountryBoundaryService {
    ...
    /// accuracy matters. Thread-safe with lazy loading.
    func getCountryOverlays() -> [String: [MKOverlay]] {
        ...
        // Load and cache
        let overlays = performLoad(resource: "world_countries")
    ...
    func getRenderOverlays() -> [String: [MKOverlay]] {
        ...
        let overlays = performLoad(resource: "world_countries_simplified")
        cachedRenderOverlays = overlays
        return overlays
    }

    private func performLoad(resource: String) -> [String: [MKOverlay]] {
